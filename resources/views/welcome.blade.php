...
<body class="bg-black text-[#1b1b18] min-h-screen flex flex-col">
    <header
        class="fixed top-0 inset-x-0 z-50 bg-black/80 backdrop-blur-md border-b border-white/10 shadow-lg shadow-black/50 not-has-[nav]:hidden">
        <livewire:menu />
    </header>
    <div
        ...
        <main class="flex w-full max-w-5xl mx-auto flex-col items-center justify-center gap-12 mt-8 px-4 lg:px-8 mb-12">
            <div class="relative group w-full overflow-hidden rounded-2xl shadow-2xl shadow-orange-500/10 border border-white/5 bg-black/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-orange-500/20">
                <img src="{{ asset('assets/1.jpg') }}" alt="Encuentro Sobre Procesamiento de Minerales" class="w-full h-auto object-contain transition-transform duration-700 group-hover:scale-105">
                <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent pointer-events-none"></div>
            </div>
            
            <div class="relative group w-full overflow-hidden rounded-2xl shadow-2xl shadow-orange-500/10 border border-white/5 bg-black/50 transition-all duration-500 hover:-translate-y-1 hover:shadow-orange-500/20">
                <img src="{{ asset('assets/2.png') }}" alt="Información del Evento" class="w-full h-auto object-contain transition-transform duration-700 group-hover:scale-105">
                <div class="absolute inset-0 bg-gradient-to-t from-black/40 via-transparent to-transparent pointer-events-none"></div>
            </div>
        </main>
    </div>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.3.8/dist/js/bootstrap.bundle.min.js" integrity="sha384-FKyoEForCGlyvwxhmIstJefSKup5DNhKhKlXaReadyCZgfNu3Fmk0xNRJqB7vWJly" crossorigin="anonymous"></script>
